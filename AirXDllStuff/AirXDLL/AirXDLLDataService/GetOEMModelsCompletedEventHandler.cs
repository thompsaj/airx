...
// Type: AirXDLL.AirXDLLDataService.GetOEMModelsCompletedEventHandler
...
namespace AirXDLL.AirXDLLDataService
{
  ...
  public delegate void GetOEMModelsCompletedEventHandler(object sender, GetOEMModelsCompletedEventArgs e);
}
