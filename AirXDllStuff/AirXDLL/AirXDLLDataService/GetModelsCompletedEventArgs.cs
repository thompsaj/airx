...
// Type: AirXDLL.AirXDLLDataService.GetModelsCompletedEventArgs
...
namespace AirXDLL.AirXDLLDataService
{
  ...
  [DebuggerStepThrough]
  public class GetModelsCompletedEventArgs : AsyncCompletedEventArgs
  {
    private object[] results;

    internal GetModelsCompletedEventArgs(object[] results, Exception exception, bool cancelled, object userState)
