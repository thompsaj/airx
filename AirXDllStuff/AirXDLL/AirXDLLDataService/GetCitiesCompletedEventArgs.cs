...
// Type: AirXDLL.AirXDLLDataService.GetCitiesCompletedEventArgs
...
namespace AirXDLL.AirXDLLDataService
{
  ...
  public class GetCitiesCompletedEventArgs : AsyncCompletedEventArgs
  {
    ...
    internal GetCitiesCompletedEventArgs(object[] results, Exception exception, bool cancelled, object userState)
